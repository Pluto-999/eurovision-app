...
participants_table = soup.find_all("table", class_ = "wikitable plainrowheaders")[0]
...
write_entries(table_entries, 2021)


################### FINAL RESULTS ###################

final_results_table = soup.find_all("table", class_ = "wikitable sortable plainrowheaders")[0]
...
write_final_results(table_entries, 2021)
...
write_semi_results(table_entries, 2021, 1)
...
write_semi_results(table_entries, 2021, 2)